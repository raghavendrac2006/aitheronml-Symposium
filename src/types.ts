...
export const MAP_EMAIL_TO_EVENT_ID: Record<string, string> = {
  ...
  'dsa@aitheronml.in': 'dsa_coding_challenge',
};
...
export const MAP_EMAIL_TO_NAME: Record<string, string> = {
  ...
  'uiux@aitheronml.in': 'UI/UX Design Host',
  'vibecoding@aitheronml.in': 'Vibe Coding Host',
  'techquiz@aitheronml.in': 'Tech Quiz Host',
  ...
  'dsa@aitheronml.in': 'DSA Coding Host',
};
...
export function normalizeEmail(emailStr: string): string {
  ...
  else if (username.startsWith('uiux') || username.startsWith('ui') || username.startsWith('ux')) normUsername = 'uiux';
